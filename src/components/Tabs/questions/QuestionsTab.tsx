...
import { Plus, FileUp, Cloud, Loader, Database, Search, Sparkles } from "lucide-react";
  ...
  if (loading)
    return (
      <div className="flex flex-col items-center justify-center py-20 animate-fadeIn">
        ...
        <p className="mt-6 text-lg font-medium text-gray-700">Carregando questões...</p>
      ...
      <div className="bg-white rounded-2xl p-6 max-w-2xl w-full max-h-[80vh] overflow-auto shadow-2xl border border-gray-100 animate-scaleIn">
        ...
        {loading ? (
          ...
          <div className="text-center py-12 bg-gray-50 rounded-xl">
            ...
            <p className="text-gray-500">Nenhum arquivo .docx encontrado no Drive</p>
          </div>
        ) : (
